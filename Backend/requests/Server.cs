        ...
        private static async Task Start()
        {
            ...
            while (run)
            {
                ...
                try
                {
                    ...
                    currentConnection.ReceiveTimeout = 500;
                ...
                try
                {
                    ...
                    if (httpRequestData.Length == 3)
                    {
                        ...
                        if (requestVersion == "HTTP/1.1")
                        {
                            ...
                            {
                                Program.log(LOG_TAG, "Exception occurred while sending response.");
                                Console.WriteLine(exception);
                            }
                        }
                    }
                } catch (Exception exception) {
                    // Just in case, to prevent any uncaught exceptions from completely crashing the application.
                    Program.log(LOG_TAG, "Uncaught exception!");
                    Console.WriteLine(exception);
                }
                ...
                try {
                    ...
                    // Socket might already be closed, doesn't really matter as an error for the application.
                }
            }
        }
    }
